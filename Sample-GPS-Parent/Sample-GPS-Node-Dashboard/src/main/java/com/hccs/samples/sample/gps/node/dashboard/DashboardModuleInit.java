...
public class DashboardModuleInit implements ModuleInit {
	...
	public String actionScan() {
		...
		System.out.println("DashboardModuleInit class, actionScan method");
		return null;
	}
	...
	public String getName() {
		// TODO Auto-generated method stub
		System.out.println("DashboardModuleInit class, getName method");
		return "Sample-GPS-Node-Dashboard";
	}

	@Override
	public void init() {
		// TODO Auto-generated method stub
		System.out.println("DashboardModuleInit class, init method");
	...
	public String topComponentScan() {
		// TODO Auto-generated method stub
		System.out.println("DashboardModuleInit class, topComponentScan method");
//		return "com.hccs.samples.sample.gps.app.topwindows";
//		return "com.hccs.samples.sample.gps.node.window";
		return "com.hccs.samples.sample.gps.node.dashboard.window";
