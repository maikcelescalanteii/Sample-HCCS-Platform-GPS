...
@TopComponent(title = "Dashboard", fxml = "/com/hccs/sample/resources/fxml/DashboardMainWindow.fxml", image = "/com/hccs/sample/resources/_16x16/studentreportcard.png", location = "container", group = "horizontal", closeable = false)
public class _DashboardWindowGlass extends PlatformTopWindow implements DashboardWindowGlass {
