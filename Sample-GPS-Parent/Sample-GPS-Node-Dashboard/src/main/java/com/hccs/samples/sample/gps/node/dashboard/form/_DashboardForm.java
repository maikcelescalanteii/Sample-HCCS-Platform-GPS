...
public class _DashboardForm extends FormBase implements DashboardForm {
	...
	public Class<?> configClass() {
		System.out.println("_DashboardForm, configClass method");
		return DashboardFormConfig.class;
	}

	@Override
	public void postContextSetup() {
		System.out.println("_DashboardForm, postContextSetup method");
...
//		window.addOnShowAction(() -> System.out.println("This form is shown."));
		...
		window.setupActions();
		System.out.println("_DashboardForm, setupActions method, start");
		...
		System.out.println("_DashboardForm, setupActions method, end");
//		filter.setOnApply(filters -> list.setData(fetch(filters)));
//		window.addOnShowAction(() -> System.out.println("This form is shown."));
	}
	...
	public void initComponents() {
		System.out.println("_DashboardForm, initComponents method");
		window.init();
		report.init();
		list.init();
...
//		attachComponents();
	...
	@Override
	public void show() {
		System.out.println("_DashboardForm, show method");
		super.show();
		window.show();
	}
	...
	private void attachComponents() {
		System.out.println("_DashboardForm, attachComponents method");
