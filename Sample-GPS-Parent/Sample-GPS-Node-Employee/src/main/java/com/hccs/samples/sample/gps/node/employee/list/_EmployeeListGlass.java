...
import com.hccs.samples.sample.gps.node.employee.details._EmployeeDetailsGlass;
...
@Glass
public class _EmployeeListGlass extends BorderPane implements EmployeeListGlass {
	...
	public void init() {
		...
		FXMLLoader loader = new FXMLLoader(_EmployeeListGlass.class.getResource("/com/hccs/sample/resources/fxml/EmployeeList.fxml"));
	...
	public GlassGrabber<Node> getGlassGrabber() {
		return new GlassGrabber<Node>() {
			...
			public Node getComponent() {
				return _EmployeeListGlass.this;
			}
		};
	}
