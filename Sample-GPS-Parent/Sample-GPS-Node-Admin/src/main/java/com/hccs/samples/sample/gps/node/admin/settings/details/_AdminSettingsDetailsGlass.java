...
@Glass
public class _AdminSettingsDetailsGlass extends BorderPane implements AdminSettingsDetailsGlass {
...
//	private Consumer<List<String>> onApply;
	...
	public void init() {
		...
		FXMLLoader loader = new FXMLLoader(_AdminSettingsDetailsGlass.class.getResource("/com/hccs/sample/resources/fxml/EmployeeDetails.fxml"));
...
//		btnClearFilter.setOnAction(event -> onClearFilter.run());
	...
	public GlassGrabber<Node> getGlassGrabber() {
		return () -> _AdminSettingsDetailsGlass.this;
	}
