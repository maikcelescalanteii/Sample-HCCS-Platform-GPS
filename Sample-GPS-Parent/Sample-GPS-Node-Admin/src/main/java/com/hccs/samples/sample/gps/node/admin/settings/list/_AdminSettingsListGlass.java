...
@Glass
public class _AdminSettingsListGlass extends BorderPane implements AdminSettingsListGlass {
	...
	public void init() {
		...
		FXMLLoader loader = new FXMLLoader(_AdminSettingsListGlass.class.getResource("/com/hccs/sample/resources/fxml/EmployeeList.fxml"));
	...
	public GlassGrabber<Node> getGlassGrabber() {
		return new GlassGrabber<Node>() {
			...
			public Node getComponent() {
				return _AdminSettingsListGlass.this;
			}
		};
	}
