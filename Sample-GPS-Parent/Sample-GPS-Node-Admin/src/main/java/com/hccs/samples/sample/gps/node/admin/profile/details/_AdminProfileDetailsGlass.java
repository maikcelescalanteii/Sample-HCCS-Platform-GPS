...
@Glass
public class _AdminProfileDetailsGlass extends BorderPane implements AdminProfileDetailsGlass {
...
//	private Consumer<List<String>> onApply;
	...
	public void init() {
		...
		FXMLLoader loader = new FXMLLoader(_AdminProfileDetailsGlass.class.getResource("/com/hccs/sample/resources/fxml/EmployeeDetails.fxml"));
...
//		btnClearFilter.setOnAction(event -> onClearFilter.run());
	...
	public GlassGrabber<Node> getGlassGrabber() {
		return () -> _AdminProfileDetailsGlass.this;
	}
