...
@TopComponent(title = "Admin Profile", fxml = "/com/hccs/sample/resources/fxml/AdminProfileMainWindow.fxml", image = "/com/hccs/sample/resources/_16x16/studentreportcard.png", location = "container", group = "horizontal", closeOperation = CloseOperation.HIDE)
public class _AdminProfileWindowGlass extends PlatformTopWindow implements AdminProfileWindowGlass {
	...
	public _AdminProfileWindowGlass() {
