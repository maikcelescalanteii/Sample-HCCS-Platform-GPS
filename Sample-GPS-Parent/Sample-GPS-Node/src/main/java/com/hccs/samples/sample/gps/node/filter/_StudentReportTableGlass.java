...
@Glass
public class _StudentReportTableGlass extends BorderPane implements StudentReportTableGlass {
...
//	private Consumer<List<String>> onApply;
	...
	public void init() {
		...
		FXMLLoader loader = new FXMLLoader(_StudentReportTableGlass.class.getResource("/com/hccs/sample/resources/fxml/StudentReportTable.fxml"));
...
//		btnClearFilter.setOnAction(event -> onClearFilter.run());
	...
	public GlassGrabber<Node> getGlassGrabber() {
		return () -> _StudentReportTableGlass.this;
	}
